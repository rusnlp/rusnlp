'''
python code/backend/search_muse/create_muse_corpus.py --texts_path=texts/en_conllu+texts/ru_conllu --lemmatize=1 --embeddings_path=code/web/models/cross_muse.bin.gz --common_vectors_path=code/web/models/common_lem_muse.bin.gz --mis_path=texts/mis_lem_en.txt+texts/mis_lem_ru.txt --task_path=code/web/data/nlpub.tsv --task_column=terms_short
python code/backend/search_muse/create_muse_corpus.py --texts_path=texts/en_conllu+texts/ru_conllu --lemmatize=0 --embeddings_path=code/web/models/cross_muse.bin.gz --common_vectors_path=code/web/models/common_tok_muse.bin.gz --mis_path=texts/mis_tok_en.txt+texts/mis_tok_ru.txt --task_path=code/web/data/nlpub.tsv --task_column=terms_short
'''
